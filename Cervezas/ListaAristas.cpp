...
// salidas: no tiene
void ListaAristas::insertarAlInicio (string pNombre)
{
     // si no hay elementos
     if (primerNodo == NULL)
     {
         // ambos apuntan al nuevo en memoria
         primerNodo = new Arista(pNombre);
         ultimoNodo = primerNodo; // ambos apuntan al nuevo
     }
     else
     {
         Arista *nuevo = new Arista(pNombre);
...
// entradas: el dato a guardar
// salidas: no tiene
void ListaAristas::insertarAlFinal (string pNombre)
{
     // si no hay elementos
     if (primerNodo == NULL)
     {
...
Arista * ListaAristas::buscar(string pNombre)
{
       Arista * tmp = primerNodo;
       while (tmp!=NULL)
       {
...
// POSICION POSICION
int ListaAristas::posicion(string pNombre)
{
    int pos = 0;
       Arista * tmp = primerNodo;
       while (tmp!=NULL)
 ...
 void ListaAristas::borrarArista(string pNombre){
    int pos =posicion(pNombre);
